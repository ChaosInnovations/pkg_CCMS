...
use Pivel\Hydro2\Models\Database\TableColumn as DatabaseTableColumn;
...
abstract class BaseObject
{
    ...
    private static function getTableName() : string {
        ...
        //  i.e. Database\Models\TestObject -> database_testobject
        //  i.e. Vendor\Database\Models\TestObject -> vendor_database_testobject
    ...
    private static function getColumns() : array {
        ...
        foreach ($class->getProperties() as $property) {
            ...
            /** @var Pivel\Hydro2\Extensions\Database\TableColumn */
            ...
            $columns[$column_name] = new DatabaseTableColumn(
                $column_name,
                $property_name,
                $sqlType,
                $phpType,
